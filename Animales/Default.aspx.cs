...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void CargarAnimales()
    {
        ...
        foreach (EntAnimal dt in lst)
        {
            ...
            literal.Text += "                            <a href=\"Informacion.aspx?id=2\"><img src=\"img/hipopotamo.jpg\" class=\"img-responsive\" title=\"Descricion de Imagenes\" /></a>";
            literal.Text += "                        </div>";
            literal.Text += "                        <div class=\"panel-body\">";
            literal.Text += "                            <div class=\"row\">";
            literal.Text += "                                <div class=\"col-md-4\">";
            literal.Text += "                                    <img src=\"img/hipoMini.jpg\" class=\"img-responsive\" />";
            literal.Text += "                                </div>";
            ...
            literal.Text += "                                </div>";
            literal.Text += "                            </div>";
            literal.Text += "                            <iframe width=\"640\" height=\"360\" src=\""+ dt.Estatus +"\" frameborder=\"0\" allowfullscreen class=\"img-responsive\" controls></iframe>";
            literal.Text += "                        </div>";
